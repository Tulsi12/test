  ...
  submitESewa = (e) => {
    ...
    if (eSewaError || eSewaPasswordError) {
      ...
      if (localStorage.getItem("courseID") === null) {
        ...
        console.log(data);
        axios
          .put("http://localhost:5000/enrollcourse", data)
          .then((result) => {
            if (result) {
                      ...
                      <h2 className="mb-0">
                        ...
                        >
                          <div className="d-flex align-items-center justify-content-between">
                            {" "}
                            <span>e-Sewa</span>{" "}
                            <img src="assets/img/esewa.png" width={30} />{" "}
                          </div>
                        </button>{" "}
                      </h2>
                    </div>
                    ...
                    >
                      <div className="card-body">
                        ...
                        <input
                          ...
                          name="eSewaNumber"
                          placeholder="E-sewa ID"
                          value={this.state.eSewaNumber}
                          onChange={this.changeState}
                        />
                        <div style={{ color: "red", fontSize: "small" }}>
                          {this.state.eSewaError}
                        </div>
                        <input
                          type="password"
                          className="form-control"
                          ...
                          value={this.state.eSewaPassword}
                          onChange={this.changeState}
                        />
                        <div style={{ color: "red", fontSize: "small" }}>
                          {this.state.eSewaPasswordError}
                        </div>
                        <div className="p-3">
                          {" "}
                          <button
                            className="btn btn-primary btn-block free-button"
                            onClick={this.submitESewa}
                          >
                            Pay Now
                          </button>
                        </div>
              ...
              <div className="card">
                <div className="d-flex justify-content-between p-3">
                  <div className="d-flex flex-column">
                    ...
                    <span>
                      {" "}
                      Course Title <i className="fa fa-caret-down" />
                    </span>{" "}
                  </div>
                  <div className="mt-1">
                    {" "}
                    <sup className="super-price">{this.state.title}</sup>
                  </div>
                </div>
                ...
                <div className="p-3">
                  <div className="d-flex justify-content-between mb-2">
                    {" "}
                    <span>Course Price</span> <span>Rs.{this.state.price}</span>{" "}
                  </div>
                </div>
                <hr className="mt-0 line" />
